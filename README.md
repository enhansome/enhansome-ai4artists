...
* [Elucidating the Design Space of Diffusion-Based Generative Models (EDM)](https://github.com/NVlabs/edm) ⭐ 1,996 | 🐛 16 | 🌐 Python | 📅 2024-03-16
...
* [Training Generative Adversarial Networks with Limited Data (StyleGAN2-ADA)](https://github.com/NVlabs/stylegan2-ada-pytorch) ⭐ 4,488 | 🐛 201 | 🌐 Python | 📅 2024-05-10
...
* [JAX](https://github.com/google/jax) ⭐ 36,316 | 🐛 2,580 | 🌐 Python | 📅 2026-09-19
* [🤗 Diffusers](https://github.com/huggingface/diffusers) ⭐ 34,549 | 🐛 1,430 | 🌐 Python | 📅 2026-09-19
...
* [DeepSpeed (training, inference, compression)](https://github.com/microsoft/DeepSpeed) ⭐ 43,142 | 🐛 1,447 | 🌐 Python | 📅 2026-09-19
...
* ⭐️ **[Stable Diffusion](https://github.com/CompVis/stable-diffusion) ⭐ 73,448 | 🐛 619 | 🌐 Jupyter Notebook | 📅 2024-06-18**
...
* ⭐️ **[Stable Diffusion Web UI](https://github.com/AUTOMATIC1111/stable-diffusion-webui) ⭐ 165,027 | 🐛 2,504 | 🌐 Python | 📅 2026-03-02**: A user friendly UI for SD with additional [features](https://github.com/AUTOMATIC1111/stable-diffusion-webui/wiki/Features) ⭐ 165,027 | 🐛 2,504 | 🌐 Python | 📅 2026-03-02 to make common workflows easy.
* [Dream Textures (Blender)](https://github.com/carson-katri/dream-textures) ⭐ 8,203 | 🐛 15 | 🌐 Python | 📅 2026-09-17: Plugin to render textures, reference images, and background with SD.
...
* [NVlabs/instant-ngp](https://github.com/NVlabs/instant-ngp) ⭐ 17,554 | 🐛 503 | 🌐 Cuda | 📅 2026-02-02
...
* [Awesome Generative Deep Art](https://github.com/filipecalegario/awesome-generative-deep-art/blob/main/README.md) ⭐ 3,540 | 🐛 315 | 📅 2025-12-18 - A curated list of Generative Deep Art / Generative AI projects, tools, artworks, and models
