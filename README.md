...
* [Training Generative Adversarial Networks with Limited Data (StyleGAN2-ADA)](https://github.com/NVlabs/stylegan2-ada-pytorch) ⭐ 4,484 | 🐛 201 | 🌐 Python | 📅 2024-05-10
...
* [Robust Video Matting](https://github.com/PeterL1n/RobustVideoMatting) ⭐ 9,513 | 🐛 123 | 🌐 Python | 📅 2024-04-02
...
* [JAX](https://github.com/google/jax) ⭐ 36,274 | 🐛 2,541 | 🌐 Python | 📅 2026-09-08
* [🤗 Diffusers](https://github.com/huggingface/diffusers) ⭐ 34,463 | 🐛 1,424 | 🌐 Python | 📅 2026-09-08
...
* [DeepSpeed (training, inference, compression)](https://github.com/microsoft/DeepSpeed) ⭐ 43,080 | 🐛 1,394 | 🌐 Python | 📅 2026-09-08
...
* ⭐️ **[Stable Diffusion Web UI](https://github.com/AUTOMATIC1111/stable-diffusion-webui) ⭐ 164,868 | 🐛 2,505 | 🌐 Python | 📅 2026-03-02**: A user friendly UI for SD with additional [features](https://github.com/AUTOMATIC1111/stable-diffusion-webui/wiki/Features) ⭐ 164,868 | 🐛 2,505 | 🌐 Python | 📅 2026-03-02 to make common workflows easy.
* [Dream Textures (Blender)](https://github.com/carson-katri/dream-textures) ⭐ 8,200 | 🐛 17 | 🌐 Python | 📅 2024-08-26: Plugin to render textures, reference images, and background with SD.
...
* [NVlabs/instant-ngp](https://github.com/NVlabs/instant-ngp) ⭐ 17,542 | 🐛 503 | 🌐 Cuda | 📅 2026-02-02
...
* [Awesome Generative Deep Art](https://github.com/filipecalegario/awesome-generative-deep-art/blob/main/README.md) ⭐ 3,534 | 🐛 304 | 📅 2025-12-18 - A curated list of Generative Deep Art / Generative AI projects, tools, artworks, and models
